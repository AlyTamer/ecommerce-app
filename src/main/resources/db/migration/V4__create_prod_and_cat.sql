...
VALUES ('Electronics', 'electronics', 'https://i.imgur.com/ZANVnHE.jpeg', 'All Type of zeros and ones products'),
       ('REST-Update', 'rest-update', 'https://placeimg.com/640/480/any', 'Rest Update Type Products')
...
VALUES ('Sleek White & Orange Wireless Gaming Controller',
...
VALUES ((SELECT id FROM products WHERE slug = 'sleek-white-orange-wireless-gaming-controller'),
        'https://i.imgur.com/ZANVnHE.jpeg'),
       ((SELECT id FROM products WHERE slug = 'sleek-white-orange-wireless-gaming-controller'),
        'https://i.imgur.com/Ro5z6Tn.jpeg'),
       ((SELECT id FROM products WHERE slug = 'sleek-white-orange-wireless-gaming-controller'),
        'https://i.imgur.com/woA93Li.jpeg'),

       ((SELECT id FROM products WHERE slug = 'sleek-comfort-fit-over-ear-headphones'),
       ...
       ((SELECT id FROM products WHERE slug = 'sleek-modern-laptop-for-professionals'),
       ...
       ((SELECT id FROM products WHERE slug = 'mid-century-modern-wooden-dining-table'),
       ...
       ((SELECT id FROM products WHERE slug = 'modern-minimalist-workstation-setup'),
       ...
       ((SELECT id FROM products WHERE slug = 'stylish-red-silver-over-ear-headphones'),
       ...
       ((SELECT id FROM products WHERE slug = 'sleek-smartwatch-with-vibrant-display'),
       ...
       ((SELECT id FROM products WHERE slug = 'elegant-golden-base-stone-top-dining-table'),
